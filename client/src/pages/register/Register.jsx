...
<<<<<<< HEAD
		...
		<div >
			<Navbar/>
			<div className="flex flex-col items-center justify-center w-full h-screen register " >
				
			<div className="w-[340px]  gap-3 flex flex-col items-center justify-center bg-white p-4 rounded-lg shadow-xl mt-[70px]">
=======
        <div>
            <Navbar />
